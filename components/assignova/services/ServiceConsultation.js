  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: "", email: "", phone: "", company: "", service: "", timeline: "", budget: "", message: "" });
      } else {
  ...
  return (
    <section id="contact" className="py-20 relative">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-dark-accent/20 to-transparent" />
            ...
            <motion.div
              ...
              <div className="flex items-center mb-8">
                <div className="p-3 rounded-xl bg-dark-accent/10 border border-dark-accent/20 mr-4">
                  <Calendar className="w-6 h-6 text-dark-accent" />
                </div>
                <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4 pt-6 border-t border-gray-800">
                  <div className="flex flex-col items-center sm:items-start w-full sm:w-auto order-2 sm:order-1">
                    ...
                    {submitStatus === "success" && <p className="text-green-500 text-sm mt-2 text-center sm:text-left">Consultation request sent successfully!</p>}
                    {submitStatus === "error" && <p className="text-red-500 text-sm mt-2 text-center sm:text-left">Failed to send request. Please try again.</p>}
                  </div>
                  <motion.button
                    ...
                    className="w-full sm:w-auto btn-primary px-8 py-4 rounded-xl text-lg flex items-center justify-center space-x-3 order-1 sm:order-2 disabled:opacity-50 disabled:cursor-not-allowed">
                    <MessageSquare className="w-5 h-5 hidden sm:block" />
                    <span>{isSubmitting ? "Sending..." : "Schedule Consultation"}</span>
