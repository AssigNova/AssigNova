        ...
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Let's Build{" "}
              <span className="text-light-accent">Together</span>
            </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4 pt-6 border-t border-gray-800">
                    <div className="flex flex-col items-center sm:items-start w-full sm:w-auto order-2 sm:order-1">
                      ...
                      {submitStatus === "success" && <p className="text-green-500 text-sm mt-2 text-center sm:text-left">Message sent successfully!</p>}
                      {submitStatus === "error" && <p className="text-red-500 text-sm mt-2 text-center sm:text-left">Failed to send message. Please try again.</p>}
                    </div>
                    <motion.button
